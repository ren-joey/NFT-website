...
class CountingHandler {
    ...
    constructor() {
        this.counterTimes = [
            getMoment(`2022/03/27 17:26`), // VIP [DEV]
            getMoment(`2022/03/27 17:27`), // 搗蛋
            getMoment(`2022/04/27 10:20`), // 全面
            getMoment(`2022/05/27 17:29`), // 解盲
            getMoment(`2022/05/27 16:20`) // 下一波活動
