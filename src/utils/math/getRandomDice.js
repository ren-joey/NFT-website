 ...
 * 上限為
 * @param {Object} param
 * @param {Number} param.total - 所有骰子總和
 * @param {Number} param.left - 剩餘的骰子數量
 * @param {Object[] = []} param.known - 已知的骰子(選填)
 * @returns {Object[]} 骰子點數總和
 */
const getRandomDice = ({ total, left, known = [] }) => {
    if (total < left
