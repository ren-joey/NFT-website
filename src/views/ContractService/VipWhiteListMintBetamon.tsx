...
const VipWhiteListMintBetamon = () => {
    const mintBetamonOptions = getWeb3ExecuteFunctionOption('vipWhiteListMintBetamon');
    const {
        isAuthenticated
    } = useMoralis();
    const {
...
export default VipWhiteListMintBetamon;