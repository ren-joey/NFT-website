...
const ZH_CN: Lang = {
    ...
    FIRST_AREA_TITLE_ARRIVED: '黑暗势力崛起！',
    FIRST_AREA_DESC: '第二波120个暗黑β星人来袭！ \n立即拥有全球限量实体公仔并兑换NFT',
    ...
    ROADMAP_CARD_6_SUBTITLE: 'The Sandbox - β乐园上线\nβ币、奖励任务等内容逐步推出将陆续公布计画细节',
    ROADMAP_CARD_6_REMARK: '＊抢先观看β乐园 ▶',
    ROADMAP_CARD_6_REMARK_HREF: 'https://youtu.be/43VJjpPGCL4',
    ROADMAP_CARD_6_BTN_LABEL: '',
    ROADMAP_CARD_6_BTN: '验证β乐园土地座标 ▶',
    ...
    MEMBER_15_TITLE: '探索士',
    MEMBER_15_NAME: 'YU',
    MEMBER_15_DESC: '具备项目管理和搜索引擎优化能力，也是个厉害的广告投手，精准投放关键目标客群',
    ABOUT_VBC_DIVIDER_1: '目前创意飞船β的成员有以下多位身怀各种绝技正打算大展身手',
    ABOUT_VBC_DIVIDER_2: '注：将随着进程持续增加成员。',
    FAQ_1_TITLE: '如何购买β星人NFT？',
    FAQ_1_CONTENT: '1. 您需要先注册Metamask钱包\n2. 于OPENSEA网站搜寻VBC Betamon进行购买\n3. 购买成功您的虚拟钱包将获得β星人NFT\n＊第一波β星人NFT公仔兑换申请截止，依申请状态派发动态NFT及PLUS版隐藏NFT\n＊未申请兑换的实体公仔，VBC将保有其所有权、使用权，同时维持880个全球限量发售承诺\n＊第二波暗黑β星人NFT取得须先至 https://shop.vbc-labs.com/ 购买公仔才可获得',
    ...
    FAQ_4_CONTENT: '＊第一波只有<span class="lang-hgl">限量880個</span>β星人登陸地球\n＊第二波：120個暗黑β星人覺醒<br />整個β星球大約有<span class="lang-hgl">1萬個</span>β星人，將依目標達成狀況陸續登陸地球第一波只有<span class="lang-hgl">限量880个</span>β星人登陆地球\n＊第二波：120个暗黑β星人觉醒 <br />整个β星球大约有<span class="lang-hgl">1万个</span>β星人，将依目标达成状况陆续登陆地球',
