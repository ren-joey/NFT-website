...
const ZH_TW: Lang = {
    ...
    FIRST_AREA_TITLE_ARRIVED: '黑暗勢力崛起！',
    FIRST_AREA_DESC: '第二波120個暗黑β星人來襲！\n立即擁有全球限量實體公仔並兌換NFT',
    ...
    ABOUT_B_CARD_2_BTN: '搶先觀看β樂園 ▶',
    ABOUT_B_CARD_2_HREF: 'https://youtu.be/43VJjpPGCL4',
    ABOUT_B_CARD_3_TITLE: '社群',
    ABOUT_B_CARD_3_DESC: '「搗蛋俱樂部」<br />將<span class="lang-hgl">不定期發送獎勵</span>與最新資訊',
    ABOUT_B_CARD_4_TITLE: '實體潮流公仔',
    ABOUT_B_CARD_4_DESC: 'RNFT專屬賦能可兌換全球限量潮玩',
    ...
    ROADMAP_CARD_5_DATE: '已完成',
    ROADMAP_CARD_5_TITLE: '啟動 β星人 實體化 超能力',
    ROADMAP_CARD_5_SUBTITLE: '開放RNFT實體潮玩兌換申請',
    ROADMAP_CARD_5_REMARK: '＊限時兌換申請，未兌換者可得隱藏版NFT\n＊隱藏版NFT 可於後續企劃使用',
    ROADMAP_CARD_6_DATE: '2023',
    ROADMAP_CARD_6_TITLE: 'β星球通道開啟',
    ROADMAP_CARD_6_SUBTITLE: 'The Sandbox - β樂園上線\nβ幣、獎勵任務等內容逐步推出將陸續公布計畫細節',
    ROADMAP_CARD_6_REMARK: '＊搶先觀看β樂園 ▶',
    ROADMAP_CARD_6_REMARK_HREF: 'https://youtu.be/43VJjpPGCL4',
    ROADMAP_CARD_6_BTN_LABEL: '',
    ROADMAP_CARD_6_BTN: '驗證β樂園土地座標 ▶',
    ...
    MEMBER_15_TITLE: '探索士',
    MEMBER_15_NAME: 'YU',
    MEMBER_15_DESC: '具備專案管理和搜尋引擎優化能力，也是個厲害的廣告投手，精準投放關鍵目標客群',
    ABOUT_VBC_DIVIDER_1: '目前創意飛船β的成員有以下多位身懷各種絕技正打算大展身手',
    ABOUT_VBC_DIVIDER_2: '註：將隨著進程持續增加成員。',
    FAQ_1_TITLE: '如何購買β星人NFT？',
    FAQ_1_CONTENT: '1. 您需要先註冊Metamask錢包\n2. 於OPENSEA網站搜尋VBC Betamon進行購買\n3. 購買成功您的虛擬錢包將獲得β星人NFT\n＊第一波β星人NFT公仔兌換申請截止，依申請狀態派發動態NFT及PLUS版隱藏NFT\n＊未申請兌換的實體公仔，VBC將保有其所有權、使用權，同時維持880個全球限量發售承諾\n＊第二波暗黑β星人NFT取得須先至 https://shop.vbc-labs.com/ 購買公仔才可獲得',
    ...
    FAQ_4_CONTENT: '＊第一波只有<span class="lang-hgl">限量880個</span>β星人登陸地球\n＊第二波：120個暗黑β星人覺醒<br />整個β星球大約有<span class="lang-hgl">1萬個</span>β星人，將依目標達成狀況陸續登陸地球',
    ...
    PROMOTION_LABEL: '預覽公仔',
    PROMOTION_TITLE_BOLD: '搗蛋變身：',
    PROMOTION_TITLE: '點我進入',
    SIGNING_MESSAGE: '你已準備好使用實體具象超能力兌換β星人公仔嗎？請先閱讀以下說明\n\n1.申請兌換β星人公仔皆需由RNFT持有者負擔簽署合約的GAS FEE費用\n2.進入申請程序，原有的RNFT會暫時傳送至VBC錢包中驗證，驗證完成後VBC將會空投給您持有原角色3D版NFT \n3.GAS FEE 為浮動值，如您交易過程看到過高的費用可取消重新嘗試\n\nβ星人期待與你相見。',
