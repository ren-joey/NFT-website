...
const EN: Lang = {
    ...
    MEMBER_5_NAME: 'JO',
    MEMBER_5_DESC: 'Experience in blockchain and AI technology for over 4 years, including working on R&D projects for Disney and ITRI.',
    MEMBER_6_TITLE: 'Weapons Officer',
    MEMBER_6_NAME: 'RY',
    MEMBER_6_DESC: '15 years of experience in graphic and product design, including projects for international brands such as GIANT and John Walker.',
    MEMBER_7_TITLE: 'Master Chief Radarman',
    MEMBER_7_NAME: 'WN',
    MEMBER_7_DESC: '6 years of experience in marketing and market analysis, cross-disciplinary integrated analysis, frequently surprising team members with innovative ideas',
    MEMBER_8_TITLE: 'Mechanician',
    MEMBER_8_NAME: 'BL',
    MEMBER_8_DESC: 'Deeply involved in front-end special effects and virtual reality technology, participated in Walmart systems and hundreds of project developments.',
    ...
    MEMBER_10_NAME: 'JS',
    MEMBER_10_DESC: 'Expert in website visual design and creative development, with over 300 projects under his belt.',
    MEMBER_11_TITLE: 'Naval architect',
    MEMBER_11_NAME: 'CH',
    MEMBER_11_DESC: 'Expert in 3D dynamic visualization, specializing in the sci-fi intergalactic genre and has participated in design projects for Sisley, TommyTrash, and Super Taste.',
    MEMBER_12_TITLE: 'Radarman',
    MEMBER_12_NAME: 'EM',
    MEMBER_12_DESC: 'A marketing whiz with 5 years of experience in the marketing field, providing imaginative creativity.',
    MEMBER_13_TITLE: 'Teleman',
    MEMBER_13_NAME: 'RT',
    MEMBER_13_DESC: 'Expert in project implementation and planning, with a background in multi-media and 6 years of experience in cross-disciplinary digital marketing.',
    MEMBER_14_TITLE: 'Navigator',
    MEMBER_14_NAME: 'OC',
    MEMBER_14_DESC: 'An expert hand-drawn illustrator and doodler who has been nominated for the Golden Pin Design Award and has extensive experience as a graphics broadcaster.',
    MEMBER_15_TITLE: '?', // [DEV]
