...
const EN: Lang = {
    ...
    FIRST_AREA_TITLE: '',
    FIRST_AREA_TITLE_ARRIVED: 'Rise of the dark forces!',
    FIRST_AREA_DESC: 'The second series of 120 Darkside Betamon NFTs are coming !\n Own and redeem a limited number of figurines worldwide!',
    ABOUT_B_DESC: '',
    ABOUT_B_DESC_PC: '',
    ...
    ABOUT_B_CARD_2_BTN: 'Land entrance ▶',
    ...
    ABOUT_B_CARD_4_TITLE: 'Real figurines',
    ABOUT_B_CARD_4_DESC: 'RNFT exchange the real figurines',
    ...
    ROADMAP_CARD_6_SUBTITLE: 'The Sandbox -β Land online.\nβ coins, bonus missions and other content will be released progressively, with details of future projects to be announced',
    ROADMAP_CARD_6_REMARK: '＊β Land entrance ▶',
    ROADMAP_CARD_6_REMARK_HREF: 'https://youtu.be/43VJjpPGCL4',
    ROADMAP_CARD_6_BTN_LABEL: '',
    ROADMAP_CARD_6_BTN: 'Verify β Land in The Sandbox ▶',
    ...
    MEMBER_15_TITLE: 'Explorer',
    MEMBER_15_NAME: 'YU',
    MEMBER_15_DESC: 'Possess project management and search engine optimization capabilities to accurately target customers.',
    ...
    FAQ_1_CONTENT: '1. You are required to register for the Metamask wallet.\n2.Search for VBC Betamon on OPENSEA to make a purchase. \n3. You would receive a Betamon NFT in your wallet if your purchase is successful. \n* 880 Betamon redeem apply was finish. VBC will send the dynamic and  plus version NFT to the holders.\n*VBC reserves the ownership and use rights of any figure that are not redeemed within the redemption period, while maintaining its commitment to sell a limited number of 880 worldwide.\n*Darkside Betamon NFTs must buy the real figure at https://shop.vbc-labs.com/ that VBC will airdrop NFT for you.',
    FAQ_2_TITLE: '',
    FAQ_2_CONTENT: '',
    FAQ_2_BTN: '',
    ...
    SUBMISSION_FAILED_ERROR_MESSAGE: 'Submission failed. Please apply again.',
    SUBMISSION_SUCCEEDED_MESSAGE: 'This NFT already finish apply.',
    ACCOUNT_ERROR_MESSAGE: 'Account error. Please try again.',
