...
// import wave from 'src/assets/images/wave.gif'; [DEV]
...
const loader = () => new Promise<void>((res) => {
    ...
    loader
        // for trailer
        // .add('b_alien_preview_head', b_alien_preview_head)
        ...
        .add('b_alien_2', b_alien_2)
        .add('b_alien_3', b_alien_3)
        .add('b_alien_4', b_alien_4)
        .add('b_alien_5', b_alien_5)
        .add('b_alien_6', b_alien_6)
        ...
        .add('blue_arrow', blue_arrow)
        .add('center_dots', center_dots)
        .add('discord_icon', discord_icon)
        .add('earth', earth)
        .add('feature_icon_1', feature_icon_1)
        .add('feature_icon_2', feature_icon_2)
        .add('feature_icon_3', feature_icon_3)
        .add('feature_icon_4', feature_icon_4)
        .add('feature_icon_5', feature_icon_5)
        .add('glowing_star', glowing_star)
        .add('icon_text_bubble', icon_text_bubble)
        .add('line_turning_around', line_turning_around)
        .add('line_turning_left', line_turning_left)
        .add('line_turning_skew', line_turning_skew)
        .add('opensea_icon', opensea_icon)
        // .add('perspective_lines', perspective_lines)
        .add('roadmap', roadmap)
        .add('rocket', rocket)
        .add('skull_icon_outline', skull_icon_outline)
        .add('skull_icon', skull_icon)
        .add('speed_lines', speed_lines)
        .add('spotlight_left', spotlight_left)
        .add('star_icon', star_icon)
...
const getResources = (key: string) => {
    if (key) return PIXI.Loader.shared.resources[key]?.url;
